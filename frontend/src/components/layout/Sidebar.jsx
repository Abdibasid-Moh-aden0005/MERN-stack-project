...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { name: 'Bookings', path: '/admin/bookings', icon: CalendarCheck, adminOnly: true },
    { name: 'Customers', path: '/admin/customers', icon: Users, adminOnly: true },
    { name: 'My Orders', path: '/my-bookings', icon: CalendarCheck, adminOnly: false, userOnly: true },
      ...
      <div className="mt-auto space-y-4 pt-6 border-t border-white/10">
        <div className="flex items-center gap-4 px-2">
          ...
          <div className="flex-1 overflow-hidden">
            ...
            <p className="text-[10px] text-text-dim truncate uppercase tracking-tighter">{user?.role || 'Customer'}</p>
          </div>
        </div>
