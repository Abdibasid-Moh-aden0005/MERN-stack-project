...
const Profile = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-1000 pb-20">
      ...
      {(message.text || error) && (
        <div
          className={`p-6 rounded border animate-in zoom-in duration-300 flex items-center gap-4 ${
        ...
        >
          <div
            className={`w-3 h-3 rounded-full animate-pulse ${message.type === "success" ? "bg-green-500" : "bg-red-500"}`}
          />
          ...
          <div className="glass-card p-10">
            <div className="flex items-center gap-3 mb-10">
              ...
              <div>
                ...
                <p className="text-[10px] text-text-dim uppercase tracking-[0.3em] font-black">
                  Personal Vault Information
                </p>
              </div>
            </div>
            ...
            <form onSubmit={handleUpdateProfile} className="space-y-8">
              <div className="grid grid-cols-2 gap-8">
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    className="w-full bg-bg-dark border border-border rounded px-6 py-4 focus:ring-1 focus:ring-primary focus:border-primary focus:outline-none transition-all font-bold text-text-main"
                  />
                </div>
                <div className="space-y-3">
                  <label className="text-[10px] font-black text-text-dim uppercase tracking-widest ml-1">
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  <Phone
                    size={18}
                    className="absolute left-6 top-1/2 -translate-y-1/2 text-text-dim"
                  />
                  <input
                    name="phone"
                    value={profileData.phone}
                    onChange={handleProfileChange}
                    className="w-full bg-bg-dark border border-border rounded pl-16 pr-6 py-4 focus:ring-1 focus:ring-primary focus:border-primary focus:outline-none transition-all font-bold text-text-main"
                  />
                </div>
              </div>
              <div className="space-y-3">
              ...
              <div className="space-y-6 pt-4">
                ...
                <div className="space-y-3">
                  <textarea
                    ...
                    onChange={handleProfileChange}
                    rows="2"
                    className="w-full bg-bg-dark border border-border rounded px-6 py-4 focus:ring-1 focus:ring-primary focus:border-primary focus:outline-none transition-all font-bold text-text-main resize-none"
                  />
                </div>
                <div className="grid grid-cols-3 gap-4">
                  <input
                    ...
                    onChange={handleProfileChange}
                    className="bg-bg-dark border border-border rounded px-6 py-4 text-text-main font-bold focus:ring-1 focus:ring-primary focus:border-primary focus:outline-none transition-all"
                  />
                  <input
                    name="state"
                    placeholder="State"
              ...
              <div className="pt-6">
                <Button
                  ...
                  icon={Save}
                  className="btn-primary w-full py-5 text-sm uppercase tracking-[0.2em] font-black shadow-xl shadow-primary/20"
                >
        ...
        <div className="lg:col-span-5 space-y-8">
          <div className="glass-card p-10">
            <div className="flex items-center gap-3 mb-10">
              ...
              <div>
                <h2 className="text-2xl font-black  capitalize tracking-tighter text-text-main">
                  Change Password
                </h2>
                <p className="text-[10px] text-text-dim uppercase tracking-[0.3em] font-black">
            ...
            <form onSubmit={handleChangePassword} className="space-y-8">
              <div className="space-y-3">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-bg-dark border border-border rounded pl-16 pr-6 py-4 focus:ring-1 focus:ring-orange-500 focus:border-orange-500 focus:outline-none transition-all text-text-main font-bold"
                  />
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    onChange={handlePasswordChange}
                    required
                    className="w-full bg-bg-dark border border-border rounded px-6 py-4 focus:ring-1 focus:ring-primary focus:border-primary focus:outline-none transition-all text-text-main font-bold"
                  />
                </div>
                <div className="space-y-3">
                  <label className="text-[10px] font-black text-text-dim uppercase tracking-widest ml-1">
              ...
              <div className="pt-4">
                <Button
                  variant="secondary"
                  loading={status === "loading"}
                  className="w-full bg-black py-5 rounded font-black uppercase tracking-[0.2em] border-orange-500/30 text-orange-600 hover:bg-orange-50 hover:border-orange-500 transition-all"
                >
                  Update Password
                </Button>
              </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-[11px] text-orange-600/80 font-bold leading-relaxed">
                  Changing your password will re-encrypt your session data. We
                  recommend using at least 12 characters with symbols and
                  numbers.
                </p>
              </div>
            </div>
