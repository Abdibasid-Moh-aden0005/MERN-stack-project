...
export const createBooking = async (req, res) => {
  try {
    ...
    const message = `Dear ${customerName}, your booking for ${carName} from ${newBooking.pickupDate.toDateString()} to the ${newBooking.dropoffDate.toDateString()} has been created successfully. Total Rent: $${newBooking.totalRent}.use this Number to pay your rent(636130932).Thank you for choosing our service!`;
